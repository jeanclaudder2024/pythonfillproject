#!/usr/bin/env python3
"""
Simple status test without Unicode characters
"""
...
def test_system_status():
    ...
    print("SUCCESS: FastAPI Service: Working")
    print("SUCCESS: Document Processing: Working")
    print("SUCCESS: PDF Generation: Working")
    print("SUCCESS: Placeholder Replacement: Working")
    print("ISSUE: Database Connection: Not working (URL issue)")
    print("SUCCESS: Fallback Data: Working (realistic data)")
    print()
    
    # Test with one vessel
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("ISSUE: SUPABASE_URL is still the placeholder")
        print("SUCCESS: SUPABASE_KEY is correct")
        print()
